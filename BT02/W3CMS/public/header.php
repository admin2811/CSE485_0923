 <div class="col-md-10 offset-md-2 vw-100">
     ...
     <div class="menu-right rounded-start-5 d-flex align-items-center flex-column bg-white justify-content-between" style="z-index: 10;">
         <div class="userLogo">
             <img src="../img/5_UwuAZQl.jpg" alt="" class="user">
         </div>
